...
PICS = (environ.get('PICS', 'https://graph.org/file/e9687e8686a68c936bf1b-31b8f28f7bce8df83d.jpg https://graph.org/file/7be869f56da8bac80ccfc-b46d72901a031c9463.jpg https://telegra.ph/file/87dcbcd5e67ad5f500dd1.mp4')).split()
...
LZURL_PRIME_USERS = [int(lazyurlers) if id_pattern.search(lazyurlers) else lazyurlers for lazyurlers in environ.get('LZURL_PRIME_USERS', '5507566909').split()]

QR_CODE_IMG = environ.get('QR_CODE_IMG','https://telegra.ph/file/ca18e2c7a1c3135b.jpg') #add url link of your qr code to recieve money - use telegraph bot or other source to get image
UPI_ID = environ.get('UPI_ID', 'lazy') #enter your upi id here - grab it from your online payment methods.

# Others
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/real_Movies186') # Tutorial video link for opening shortlink website 
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'olamfilmsbot')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "False")), False)
IMDB = is_enabled((environ.get('IMDB', "True")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "False")), False)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "⚡<b>File uploaded by [GREENMOVIES ©](https://t.me/armoviechat)</b>⚡\n\n📂<b>File Name:</b> ⪧ {file_caption} \n <b>Size: </b>{file_size}\n\n❤")
...
ADMIN_USRNM = environ.get('ADMIN_USRNM','ar_aswin_achu') # WITHOUT @
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','armoviechat') # WITHOUT @
DEV_CHANNEL_USRNM = environ.get('DEV_CHANNEL_USRNM','armoviechat') # WITHOUT @
LAZY_YT_HANDLE = environ.get('LAZY_YT_HANDLE','armoviechat')  # WITHOUT @ [  add only handle - don't add full url  ] 
MOVIE_GROUP_USERNAME = environ.get('MOVIE_GROUP_USERNAME', "greenmovie_bot") #[ without @ ]
...
DOWNLOAD_TEXT_URL = "https://t.me/Movies_greens"

# Custom Caption Under Button #
CAPTION_BUTTON = "Get Updates"
CAPTION_BUTTON_URL = "https://t.me/Movies_greens"
