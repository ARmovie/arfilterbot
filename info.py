...
REQ_CHANNEL = int(environ.get("REQ_CHANNEL","-1001607950761"))

#ai
AI = is_enabled((environ.get("AI","True")), False)
OPENAI_API = environ.get("OPENAI_API","")
LAZY_AI_LOGS = int(environ.get("LAZY_AI_LOGS","-1002174528983")) #GIVE YOUR NEW LOG CHANNEL ID TO STORE MESSAGES THAT THEY SEARCH IN BOT PM.... [ i have added this to keep an eye on the users message, to avoid misuse of LazyPrincess ]
